      ...
      <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-8 border border-slate-200">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-700 mb-4">By using the Site, you represent and warrant that:</p>
          ...
          <section>
            ...
            <p className="text-slate-700 mb-4">You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
            <p className="text-slate-700">As a user of the Site, you agree not to:</p>
            <ul className="list-disc pl-6 text-slate-700 space-y-2">
